...
import org.jmrtd.test.api.lds.FaceInfoTest;

public class DG2FileTest extends TestCase {

    private static final String BSI_TEST_FILE = "C:\\Users\\star.li\\Desktop\\0102.bin";
    ...
    public void testConstruct() throws IOException {
        ...
        byte[] array = Files.readAllBytes(Paths.get("C:\\Users\\star.li\\Desktop\\277088.jpg"));
        FileOutputStream fos = new FileOutputStream("C:\\Users\\star.li\\Desktop\\277088.bin");
        fos.write(array );
        fos.close();
...
//                    										while (true) { }
    ...
    public void testImageBytes0(File testFile) {
        try {
            ...
            System.out.println("DEBUG: " + Hex.bytesToHexString(b1));
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
    ...
    public void testCreate() {
        try {
            ...
            byte[] encode = new byte[100000];
            System.arraycopy(dg2.getEncoded(), 0, header, 0, header.length);
            System.arraycopy(dg2.getEncoded(), 0, encode, 0, header.length);
            System.out.println(Hex.bytesToPrettyString(header));
            System.out.println(Hex.bytesToPrettyString(dg2.getEncoded()));
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
